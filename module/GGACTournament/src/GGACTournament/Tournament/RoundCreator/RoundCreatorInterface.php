 ...
 * @author schurix
 */
interface RoundCreatorInterface extends ObjectManagerAwareInterface {
	
	/**
	 * @param TeamdataManager $teamdataManager
	 * @return RoundCreatorInterface
	 */
	...
	/**
	 * Returns default round config
	 * @return RoundConfig
	 */
	public function getDefaultConfig();
	
	/**
	 * Creates new round and inserts it into database.
	 * @param RoundConfig $roundConfig
	 * @param AlreadyPlayedInterface $gameCheck
	 * @return Round
	 */
