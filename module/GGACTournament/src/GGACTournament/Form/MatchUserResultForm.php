 ...
 * UserMatchResultForm
 */
class MatchUserResultForm extends Form implements InputFilterProviderInterface{
	...
	public function setObject($object) {
		if($object instanceof Match){
			$this->get('match')->get('games')->setOption('count', count($object->getGames()));
		}
	...
	public function init(){
		...
		$this->add(array(
			'name' => 'match',
			'type' => MatchUserResultFieldset::class,
			'options' => array(
