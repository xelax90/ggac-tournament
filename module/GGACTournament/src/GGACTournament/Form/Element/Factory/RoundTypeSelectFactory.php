...
/**
 * Description of RoundTypeSelectFactory
 *
 * @author schurix
 */
class RoundTypeSelectFactory extends InvokableFactory{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
		...
		$types = $manager->getRoundTypes();
		
		/* @var $element \GGACTournament\Form\Element\RoundTypeSelect */
