...
use GGACTournament\Tournament\Phase\Manager;
 ...
 * @author schurix
 */
class AdminTournamentPhaseControllerFactory extends InvokableFactory{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACTournament\Controller\AdminTournamentPhaseController */
		...
		$manager = $services->get(Manager::class);
		
		$controller->setPhaseManager($manager);
		return $controller;
	}
}
