...
/**
 * Description of AdminGroupTeamControllerFactory
 *
 * @author schurix
 */
class AdminGroupTeamMappingControllerFactory extends InvokableFactory{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACTournament\Controller\AdminGroupTeamMappingController */
