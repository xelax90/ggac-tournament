...
/**
 * Description of TeamControllerFactory
 *
 * @author schurix
 */
class TeamControllerFactory extends AbstractTournamentControllerFactory{
	public function __invoke(\Interop\Container\ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACTournament\Controller\TeamController */
