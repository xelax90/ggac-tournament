...
/**
 * Description of UserReportControllerFactory
 *
 * @author schurix
 */
class UserReportControllerFactory extends AbstractTournamentControllerFactory{
	public function __invoke(\Interop\Container\ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACTournament\Controller\UserReportController */
