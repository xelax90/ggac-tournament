...
/**
 * Description of AdminRegistrationControllerFactory
 *
 * @author schurix
 */
class AdminRegistrationControllerFactory extends InvokableFactory{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACTournament\Controller\AdminRegistrationController */
		...
		$registrationManager = $services->get(RegistrationManager::class);
