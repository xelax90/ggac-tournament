...
/**
 * Description of AdminRoundControllerFactory
 *
 * @author schurix
 */
class AdminRoundControllerFactory extends InvokableFactory{
	public function __invoke(\Interop\Container\ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACTournament\Controller\AdminRoundController */
		...
		$roundmanager = $services->get(RoundCreatorManager::class);
		$provider = $services->get(Provider::class);
		$controller->setRoundCreatorManager($roundmanager);
