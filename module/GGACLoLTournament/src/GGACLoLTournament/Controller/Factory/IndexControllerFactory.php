...
namespace GGACLoLTournament\Controller\Factory;
 ...
 * @author schurix
 */
class IndexControllerFactory extends InvokableFactory{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
		/* @var $controller \GGACLoLTournament\Controller\IndexController */
